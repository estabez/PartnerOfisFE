...
import {modalCancelToggle, setOrderID, spinnerToggle,setCancelStatus} from "../redux/actions";
                    ...
                    <ModalBody>
                        ...
                        <div style={{
                            ...
                            <button style={{
                                ...
                                height:'2.25em',
                                lineHeight:'1.5'
                            }} onClick={() => this.props.setModalCancel()}> Hayır</button>
                            <button style={{
                                marginLeft:'.25rem',
                                marginRight:'.25rem',
                                marginBottom:'.5rem',
...
function mapDispatchToProps(dispatch) {
    return {
        setModalCancel: () => dispatch(modalCancelToggle()),
